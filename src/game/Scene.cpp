...
void Scene::loadLevel(const std::string &file)
{
	...
	if(lvl_file)
	{
		...
		nb_sections = (int)ceil(width/SECTION_WIDTH);
...
sf::RenderWindow& Scene::getWindow() { return game->getWindow(); }
Player& Scene::getPlayer() { return *character; };
