...
/* ------------------------------------------------------------         */
/* Description :                                                        */
/*  Cette classe permet de cr�er un bouton rectangulaire                */
...
// proc�dure qui permet de red�finir la couleur du bouton
    void setColorButton(sf::Color color);

// redifnition de la m�thode draw afin de dessin� le bouton avec son texte respectif
